...
| 任务 | 状态 | 备注 |
|---|---|---|
| Task 1 WASD 平滑移动 | ⬜ 待开始 | |
| Task 2 curve/sector 元素类型 | ⬜ 待开始 | |
| Task 3 mindMapLayout 引擎 | ⬜ 待开始 | |
| Task 4 applyMindMap 工具 | ⬜ 待开始 | |
| Task 5 chartLayout 引擎 + polyline arrow | ⬜ 待开始 | |
| Task 6 applyChart 工具 | ⬜ 待开始 | |
| Task 7 三模式提示与请求流 | ⬜ 待开始 | |
| Task 8 收尾（changelog/README/检查点） | ⬜ 待开始 | |

**当前验证基线**：`npm test` = 21 文件 212 测试全绿（tsc --noEmit + vitest）。
