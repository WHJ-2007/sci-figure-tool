...
| Task 8 收尾（changelog/README/检查点） | ✅ 完成 | 本提交：README 补三种模式与 WASD、changelog 核对、偏离记录同步 |

**当前验证基线**：`npm test` = 23 文件 246 测试全绿（tsc --noEmit + vitest，2026-08-06 Task 8 收尾时点）；`next dev -p 3001` 编译通过（用户实例 200 响应）。
