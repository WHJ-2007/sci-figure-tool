...
export default function GenerationToast() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-4 left-4 z-50 max-w-xs rounded-lg border border-white/40 bg-white/70 px-3 py-2 text-left text-sm text-gray-800 shadow-lg backdrop-blur-md transition-all duration-200 ${
